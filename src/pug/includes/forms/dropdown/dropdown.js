    ...
    //     var content = (select.nextElementSibling.classList.contains('dropdown__content')) ? select.nextElementSibling : select.nextElementSibling.nextElementSibling;
        if (!e.target.closest('.dropdown')) {
            selects.forEach((select) => {
                const content = select.parentElement.querySelector('.dropdown__content');
                content.style.display = '';
            ...
            selects.forEach((select) => {
                if (select.closest('.dropdown') !== e.target.closest('.dropdown')) {
                    const content = select.nextElementSibling.classList.contains('dropdown__content') ? select.nextElementSibling : select.nextElementSibling.nextElementSibling;
                    content.style.display = '';
                    content.classList.remove('arrival', 'depart');
                    select.classList.remove('active');
                }
